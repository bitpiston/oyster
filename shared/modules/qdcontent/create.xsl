<xsl:template match="/oyster/qdcontent[@action = 'create']" mode="heading">Create a Page</xsl:template>
<xsl:template match="/oyster/qdcontent[@action = 'create']" mode="description">
	asdfasdfsdf
</xsl:template>

<xsl:template match="/oyster/qdcontent[@action = 'create']" mode="content">
